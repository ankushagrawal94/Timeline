...
- (void)viewDidLoad {
    ...
    NSDictionary *dict2 = @{@"artist": @"The Colorist 2", @"start": [[NSDate alloc] initWithTimeIntervalSince1970:1424506200], @"end": [[NSDate alloc] initWithTimeIntervalSince1970:1424508000], @"stage": @2, @"image": [UIImage imageNamed:@"blueish.jpg"], @"duration": @30};
